  ...
  module Day03
    module Part01
      class Part01Test < Test::Unit::TestCase
        ...
        def test_extract_a_symbol_before_a_number
          line = ".../47"
          expected_result_with_metadata = [ { symbol: '/', index: 3, line: 2 }]
        ...
        def test_sums_engine_part_numbers
          assert_equal 4361, Part01.get_sum_of_engine_part_numbers(engine_schematic)
        end
    ...
    module Part02
      class Part02Test < Test::Unit::TestCase
        ...
        def test_get_gear_ratio
          ...
          assert_equal 16345, Part02.get_gear_ratio(gear)
        end

        def test_get_sum_of_gear_ratios
          assert_equal 467835, Part02.get_sum_of_gear_ratios(engine_schematic)
        end
